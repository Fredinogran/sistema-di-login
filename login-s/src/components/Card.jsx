    ...
    <>
      <a href="#" className="block rounded-lg p-4 shadow-xs shadow-indigo-100">
        ...
        <div className="mt-2">
          <dl>
            <div>
              <dt className="sr-only">prezzo</dt>

              <dd className="text-sm text-gray-500">{prezzo}</dd>
            </div>

            <div>
              <dt className="sr-only">Address</dt>

              <dd className="font-medium">{via}</dd>
            </div>
          </dl>
          ...
          <div className="mt-6 flex items-center gap-8 text-xs">
            <div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
              ...
              <div className="mt-1.5 sm:mt-0">
                ...
                <p className="font-medium">{parcheggio}</p>
              </div>
            </div>
            ...
            <div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
              ...
              <div className="mt-1.5 sm:mt-0">
                ...
                <p className="font-medium">{bagni}</p>
              </div>
            </div>
